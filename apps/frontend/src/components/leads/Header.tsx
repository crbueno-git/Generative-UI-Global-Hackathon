    ...
    <header className="flex flex-wrap items-end justify-between gap-4 pb-5">
      <div className="min-w-0">
        ...
        <div className="flex items-center gap-4 mt-1">
          ...
          <a href="/shop" className="text-xs font-medium text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-md hover:bg-emerald-100 transition-colors border border-emerald-100">
            Copilot Shop (Gemini Live) →
          </a>
        </div>
      </div>
